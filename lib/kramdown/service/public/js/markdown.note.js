...
var markdown_note_new = function( opts ) {
    ...
    var kramdown = kramdown_new( { api_url: 'http://localhost:9292/markdown' } );
    // kramdown api service / engine (see kramdown.js)
   
    var engines = [
      { name:    'kramdown in GitHub-Flavored Markdown (GFM) Mode', format: 'HTML',  markdown: kramdown.convert_to_html   },
      { name:    'kramdown in GitHub-Flavored Markdown (GFM) Mode', format: 'LaTeX', markdown: kramdown.convert_to_latex  }
    ];
